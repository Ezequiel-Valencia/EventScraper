...
class TestICALScraper(unittest.TestCase):
    ...
    def test_ical_scraper_correctness(self):
        ...
        address = GenericAddress(
            geom="-72.6796498;41.7677107",
            locality=" Hartford",
            postalCode=" 06103",
            street=" 350 Asylum St.",
        ...
        test_event_template = GenericEvent(
            publisher_specific_info=mobilizon_metadata,
            title="Test Title",
            description="Test description",
            begins_on="",
            physical_address=address,
        )
        test_kernel = GroupEventsKernel(
            test_event_template,
            "",
        ...
        retrieved: list[AllEventsFromAGroup] = ical_scraper.retrieve_from_source(
            test_kernel
        )
        ...
        test_event = GenericEvent(
            mobilizon_metadata,
            title="Black-eyed Sally’s Jazz Jam",
            description="""Automatically scraped by Event Bot :
